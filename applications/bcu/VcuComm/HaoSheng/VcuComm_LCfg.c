...
const VcuComm_SendIPduCfgType VcuComm_IPduSendConfigInfo[PDUR_CFG_VCUCOMM_TX_PDUID_NUM] = {
    {
        (uint16)PDUR_VCUCOMM_TX_PDUID_00000770, /**< IPdu */
        8U, /**< Length */
        50U, /**< Cycle */
        NULL, /**< CondFunc */
        VcuComm_GetStatusMsg_0x770, /**< Func */
    },
    {
...
static const VcuComm_RecIPduInfoType VcuComm_Stage1RecItem[] = {
    {
        ...
        NULL/*VcuComm_ReceiveCbk*/, /**< RecFunc: 数据接收回调函数 */
        NULL/*VcuComm_RecTimeoutCbk*/, /**< TimeoutEventFunc: 数据接收超时事件回调函数 */
    },
    {
        (uint16)PDUR_VCUCOMM_RX_PDUID_00000000, /**< IPdu */
        8U,
        VCUCOMM_REC_TIMEOUT_DEFAULT, /**< Timeout: 接收超时时间 */
        NULL, /**< TimeoutFunc: 获取IPdu接收超时时间回调函数 */
