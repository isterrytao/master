...
const VcuComm_SendIPduCfgType VcuComm_IPduSendConfigInfo[PDUR_CFG_VCUCOMM_TX_PDUID_NUM] = {
    {
        (uint16)PDUR_VCUCOMM_TX_PDUID_00000200, /**< IPdu */
        8U, /**< Length */
        100U, /**< Cycle */
        NULL, /**< CondFunc */
        VcuComm_GetStatusMsg_0x200, /**< Func */
    },
    {
    ...
    {
        (uint16)PDUR_VCUCOMM_TX_PDUID_00000190, /**< IPdu */
        8U, /**< Length */
        100U, /**< Cycle */
        NULL, /**< CondFunc */
        VcuComm_GetStatusMsg_0x190, /**< Func */
    },
    {
        (uint16)PDUR_VCUCOMM_TX_PDUID_000005F2, /**< IPdu */
        8U, /**< Length */
        100U, /**< Cycle */
        VcuComm_SendConditionCheck, /**< CondFunc */
        VcuComm_GetStatusMsg_0x5F2, /**< Func */
    }
};

static const VcuComm_RecIPduInfoType VcuComm_Stage1RecItem[] = {
    {
        (uint16)PDUR_VCUCOMM_RX_PDUID_000006F2, /**< IPdu */
        8U,
