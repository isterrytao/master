...
void VcuComm_GetStatusMsg_0x18FFA2F4(uint8 *buf, uint16 *Length) {
    sint16 sval;
    uint16 uval;
    uint16 index = 0U;
...
void VcuComm_GetStatusMsg_0x18FFA4F4(uint8 *buf, uint16 *Length) {
...
void VcuComm_GetStatusMsg_0x18FFA5F4(uint8 *buf, uint16 *Length) {
    uint8 val8;
    uint16 index = 0U;
...
void VcuComm_GetStatusMsg_0x18FFAFF4(uint8 *buf, uint16 *Length) {
...
Std_ReturnType VcuComm_SendMsgCond_0x18FFAFF4(uint16 IPdu)
{
    Std_ReturnType res = E_NOT_OK;
    uint16 temp;
    uint16 index = 0U;
