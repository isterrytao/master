...
const VcuComm_SendIPduCfgType VcuComm_IPduSendConfigInfo[PDUR_CFG_VCUCOMM_TX_PDUID_NUM] = {
    {
        (uint16)PDUR_VCUCOMM_TX_PDUID_00000181, /**< IPdu */
        8U, /**< Length */
        600U, /**< Cycle */
        NULL, /**< CondFunc */
        VcuComm_GetStatusMsg_0x181, /**< Func */
    },
    {
        (uint16)PDUR_VCUCOMM_TX_PDUID_00000281, /**< IPdu */
        8U, /**< Length */
        600U, /**< Cycle */
        NULL, /**< CondFunc */
        VcuComm_GetStatusMsg_0x281, /**< Func */
    },
};

static const VcuComm_RecIPduInfoType VcuComm_Stage1RecItem[] = {
    {
        (uint16)PDUR_VCUCOMM_RX_PDUID_00000394, /**< IPdu */
        8U,
