...
const HvProcess_StateInfoType HvProcess_DchgStartInfoConfig[] = {
    {
        ...
        (uint16)HVPROCESS_DCHG_HEATER_RLY_FAULT_CHECK, /**< Next: 下一状态 */
    },
    {
        HvProcess_DchgRlyFaultCond, /**< Cond: 条件函数指针 */
        HvProcess_DchgRlyFaultAction, /**< Action: 动作函数指针 */
        (uint16)HVPROCESS_DCHG_START, /**< Next: 下一状态 */
    },
};

const HvProcess_StateInfoType HvProcess_DchgHeatRlyFaultChkInfoConfig[] = {
    {
    ...
    {
        HvProcess_DchgHeaterRelayIsNormal, /**< Cond: 条件函数指针 */
        HvProcess_DchgHeaterRelayNormalAction, /**< Action: 动作函数指针 */
...
const HvProcess_StateInfoType HvProcess_DchgRelayOffDelayInfoConfig[] = {
    {
        ...
        (uint16)HVPROCESS_DCHG_RESTART_ALLOW, /**< Next: 下一状态 */
    },
};

const HvProcess_StateInfoType HvProcess_DchgRestartInfoConfig[] = {
    {
        HvProcess_DchgReStartJudgeCond, /**< Cond: 条件函数指针 */
        HvProcess_DchgReStartJudgeAction, /**< Action: 动作函数指针 */
        (uint16)HVPROCESS_DCHG_START, /**< Next: 下一状态 */
    },
};
...
const HvProcess_StateConfigType HvProcess_DchgStateConfig[HVPROCESS_DCHG_STATE_MAX] = {
    ...
    {
        (uint8)ARRAY_SIZE(HvProcess_DchgHeatRlyFaultChkInfoConfig), /**< Num: 状态配置个数 */
        HvProcess_DchgHeatRlyFaultChkInfoConfig, /**< State: 状态信息指针 */
    },
    {
    ...
    {
        (uint8)ARRAY_SIZE(HvProcess_DchgRestartInfoConfig), /**< Num: 状态配置个数 */
        HvProcess_DchgRestartInfoConfig, /**< State: 状态信息指针 */
    },
};
