...
#if PDUR_CFG_CHARGERCOMM_TX_PDUID_NUM > CHARGERCOMM_GB_CHR_TX_PDUID_NUM
#define CHARGERCOMM_USER_CHR_TX_PDUID_NUM       (PDUR_CFG_CHARGERCOMM_TX_PDUID_NUM - CHARGERCOMM_GB_CHR_TX_PDUID_NUM)
#else
