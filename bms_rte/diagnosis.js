...
module.exports = {
    process: function(cfgData, info) {
        ...
        var diagnosisitems = [
            {name:"充电单体电压高", diagnosisType:"HIGH", condition:"CHG", def:"CHG_HV", altdef:["CALIBRATE_START", "VOLT_START"], getval: "Statistic_GetBcuHvMax", validate:"CellDataM_VoltageIsValid", valueReady:"CellDataM_AllSlaveVoltageIsReceive"},
            {name:"放电单体电压高", diagnosisType:"HIGH", condition:"DCHG", def:"DCHG_HV", getval:"Statistic_GetBcuHvMax", validate:"CellDataM_VoltageIsValid", valueReady:"CellDataM_AllSlaveVoltageIsReceive"},
            {name:"充电单体电压低", diagnosisType:"LOW", condition:"CHG", def:"CHG_LV", getval:"Statistic_GetBcuLvMax", validate:"CellDataM_VoltageIsValid", valueReady:"CellDataM_AllSlaveVoltageIsReceive"},
            {name:"放电单体电压低", diagnosisType:"LOW", condition:"DCHG", def:"DCHG_LV", getval:"Statistic_GetBcuLvMax", validate:"CellDataM_VoltageIsValid", valueReady:"CellDataM_AllSlaveVoltageIsReceive"},
            ...
            {name:"充电单体压差", diagnosisType:"HIGH", condition:"CHG", def:"CHG_DV", getval:"Statistic_GetBcuDvMax", validate:"CellDataM_VoltageIsValid", valueReady:"CellDataM_AllSlaveVoltageIsReceive"},
            {name:"放电单体压差", diagnosisType:"HIGH", condition:"DCHG", def:"DCHG_DV",altdef:["VOLT_STOP"], getval:"Statistic_GetBcuDvMax", validate:"CellDataM_VoltageIsValid", valueReady:"CellDataM_AllSlaveVoltageIsReceive"},
            {name:"充电高温", diagnosisType:"HIGH", condition:"CHG", def:"CHG_HT",altdef:["TEMPERATURE_START"], getval:"Statistic_GetBcuHtMax", validate:"CellDataM_TemperatureIsValid", valueReady:"CellDataM_AllSlaveTemperatureIsReceive"},
            {name:"放电高温", diagnosisType:"HIGH", condition:"DCHG", def:"DCHG_HT", getval:"Statistic_GetBcuHtMax", validate:"CellDataM_TemperatureIsValid", valueReady:"CellDataM_AllSlaveTemperatureIsReceive"},
            {name:"充电低温", diagnosisType:"LOW", condition:"CHG", def:"CHG_LT", getval:"Statistic_GetBcuLtMax", validate:"CellDataM_TemperatureIsValid", valueReady:"CellDataM_AllSlaveTemperatureIsReceive"},
            {name:"放电低温", diagnosisType:"LOW", condition:"DCHG", def:"DCHG_LT", getval:"Statistic_GetBcuLtMax", validate:"CellDataM_TemperatureIsValid", valueReady:"CellDataM_AllSlaveTemperatureIsReceive"},
            {name:"充电温差", diagnosisType:"HIGH", condition:"CHG", def:"CHG_DT", getval:"Statistic_GetBcuDtMax", validate:"CellDataM_TemperatureIsValid", valueReady:"CellDataM_AllSlaveTemperatureIsReceive"},
            {name:"放电温差", diagnosisType:"HIGH", condition:"DCHG", def:"DCHG_DT",altdef:["TEMPERATURE_STOP"], getval:"Statistic_GetBcuDtMax", validate:"CellDataM_TemperatureIsValid", valueReady:"CellDataM_AllSlaveTemperatureIsReceive"},
            ...
            {name:"SOC过低", diagnosisType:"LOW", condition:"ALL", def:"LSOC",altdef:["SOC_STOP"], getval:"Soc_Get", validate:"Soc_SocIsValid"},
            ...
            {name:"充电加热高温", diagnosisType:"HIGH", condition:"CHG", def:"CHG_HEAT_HT", getval:"TemperatureM_GetChgHeatTemperatureMax", validate:"CellDataM_TemperatureIsValid", valueReady:"CellDataM_AllSlaveTemperatureIsReceive"},
            {name:"放电加热高温", diagnosisType:"HIGH", condition:"DCHG", def:"DCHG_HEAT_HT", getval:"TemperatureM_GetDchgHeatTemperatureMax", validate:"CellDataM_TemperatureIsValid", valueReady:"CellDataM_AllSlaveTemperatureIsReceive"},
            {name:"充电加热温差", diagnosisType:"HIGH", condition:"CHG", def:"CHG_HEAT_DT", getval:"TemperatureM_GetChgHeatDeltaTemperatureMax", validate:"CellDataM_TemperatureIsValid", valueReady:"CellDataM_AllSlaveTemperatureIsReceive"},
            {name:"放电加热温差", diagnosisType:"HIGH", condition:"DCHG", def:"DCHG_HEAT_DT", getval:"TemperatureM_GetDchgHeatDeltaTemperatureMax", validate:"CellDataM_TemperatureIsValid", valueReady:"CellDataM_AllSlaveTemperatureIsReceive"},
            ...
            {name:"充电极柱高温", diagnosisType:"HIGH", condition:"CHG", def:"CHG_POLE_HT", getval:"Statistic_GetBcuPoleHtMax", validate:"CellDataM_TemperatureIsValid", valueReady:"CellDataM_AllSlaveTemperatureIsReceive"},
            ...
            {name:"加热温感异常", diagnosisType:"HIGH", condition:"ALL", def:"HEAT_TEMP_LINE_FAULT", getval:"Statistic_GetBcuInvalidHeatTemperatureNum", valueReady:"CellDataM_AllSlaveTemperatureIsReceive"},
            {name:"极柱温感异常", diagnosisType:"HIGH", condition:"ALL", def:"POLE_TEMP_LINE_FAULT", getval:"Statistic_GetBcuInvalidPoleTemperatureNum", valueReady:"CellDataM_AllSlaveTemperatureIsReceive"},
