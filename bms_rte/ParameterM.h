...
typedef enum{
    ...
    PARAMETERM_EEEP_CUMULATIVE_FEEDBACK_CAP_L_INDEX = 35, /**< 累计回馈容量低字节 */
    PARAMETERM_EEEP_CUMULATIVE_FEEDBACK_CAP_H_INDEX = 36, /**< 累计回馈容量高字节 */

    PARAMETERM_EEEP_VCU_EEPROM_GROUP1_DATA1 = 37,
    PARAMETERM_EEEP_VCU_EEPROM_GROUP1_DATA2 = 38,
    PARAMETERM_EEEP_VCU_EEPROM_GROUP2_DATA1 = 39,
    PARAMETERM_EEEP_VCU_EEPROM_GROUP2_DATA2 = 40,
    PARAMETERM_EEEP_VCU_EEPROM_GROUP3_DATA1 = 41,
    PARAMETERM_EEEP_VCU_EEPROM_GROUP3_DATA2 = 42,
    PARAMETERM_EEEP_VCU_EEPROM_GROUP4_DATA1 = 43,
    PARAMETERM_EEEP_VCU_EEPROM_GROUP4_DATA2 = 44,
    PARAMETERM_EEEP_VCU_EEPROM_GROUP5_DATA1 = 45,
    PARAMETERM_EEEP_VCU_EEPROM_GROUP5_DATA2 = 46,
    PARAMETERM_EEEP_VCU_EEPROM_GROUP6_DATA1 = 47,
    PARAMETERM_EEEP_VCU_EEPROM_GROUP6_DATA2 = 48,
    PARAMETERM_EEEP_VCU_EEPROM_GROUP7_DATA1 = 49,
    PARAMETERM_EEEP_VCU_EEPROM_GROUP7_DATA2 = 50,
    PARAMETERM_EEEP_VCU_EEPROM_GROUP8_DATA1 = 51,
    PARAMETERM_EEEP_VCU_EEPROM_GROUP8_DATA2 = 52,

    PARAMETERM_EEEP_LOWER_INDEX_END = 52, /**< 低段参数索引结束(不单独占用一个索引)， 注：处于PARAMETERM_EEEP_LOWER_INDEX_END和PARAMETERM_EEEP_HIGHER_INDEX_START之间的参数不进行存储有效性校验 */
