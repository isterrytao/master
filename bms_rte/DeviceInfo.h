...
typedef enum{
    ...
    DEVICE_TYPE_C601 = 0x02U, /**< 同C600，支持2G远程无线数据通信 */
    ...
    DEVICE_TYPE_A603 = 0x83U, /**< 48路电压检测、8路温度检测、100mA被动均衡、2G，其它同C601 */
    DEVICE_TYPE_A605 = 0x85U, /**< 24路电压检测、8路温度检测、100mA被动均衡、4G，其它同C601 */
    DEVICE_TYPE_A607 = 0x87U, /**< 48路电压检测、8路温度检测、100mA被动均衡、4G，其它同C601 */
