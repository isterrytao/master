...
#define OS_LOWEST_PRIO            25    /* Defines the lowest priority that can be assigned ...         */
                                       /* ... MUST NEVER be higher than 254!                           */

#define OS_MAX_EVENTS             23    /* Max. number of event control blocks in your application      */
...
#define OS_MAX_TASKS              24    /* Max. number of tasks in your application, MUST be >= 2       */
...
#define OS_TASK_IDLE_STK_SIZE   40     /* Idle       task stack size (# of OS_STK wide entries)        */
#define OS_TASK_IDLE_STK_SIZE_HARD 28
...
#define OS_TMR_CFG_MAX           2    /*     Maximum number of timers                                 */
