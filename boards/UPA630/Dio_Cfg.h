...
#define DIO_CHANNEL_LTC68XX_CS            DIO_CHANNEL(S, 7U)
...
#define DIO_CHANNEL_DTU_ID                DIO_CHANNEL(K, 2U) /**< DTU子板是否安装识别 */
...
#define DIO_CHANNEL_ADC_SPI_CS1           DIO_CHANNEL(H, 7U) /**< SPI ADC CS控制1 */
//#define DIO_CHANNEL_ADC_SPI_CS2           DIO_CHANNEL(S, 0U) /**< SPI ADC CS控制2 */

#define DIO_CHANNEL_SHUNT_INT             DIO_CHANNEL(J, 7U) /**< 分流器中断输入 */
#define DIO_CHANNEL_SHUNT_RESET           DIO_CHANNEL(C, 5U) /**< 分流器复位 */
