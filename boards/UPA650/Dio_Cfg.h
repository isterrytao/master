...
#define DIO_CHANNEL_CHARGER_GB_S2         DIO_CHANNEL(AN_08_15, 4U) /**< 国标充电S2开关控制 */
...
#define DIO_CHANNEL_SW_IN_1               DIO_CHANNEL(AN_00_07, 4U) /**< 开关量输入1 */
...
#define DIO_CHANNEL_HSS_2                 DIO_CHANNEL(D, 2U) /**< 高边开关2输出控制 */
#define DIO_CHANNEL_HSS_3                 DIO_CHANNEL(A, 0U) /**< 高边开关3输出控制 */
#define DIO_CHANNEL_HSS_4                 DIO_CHANNEL(P, 7U) /**< 高边开关4输出控制 */
...
#define DIO_CHANNEL_ISL78600_EN           DIO_CHANNEL(K, 6U)   // PK6 输出
#define DIO_CHANNEL_ISL78600_DREADY       DIO_CHANNEL(P, 3U)   // PP3 输入
